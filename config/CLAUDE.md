...
- Pasta pequena por natureza; não vire depósito de constante de jogo. Valor que o jogador não muda (empuxo do modelo, gravidade da região) é dado da entidade e vai na `data/` dela.

...
- Uma subpasta por tela/componente (`hud/`, `pausa/`, `inventario/`), com cena + script juntos, seguindo a mesma estrutura de folha das outras entidades.
...
**Conceito:** seções 6 (legibilidade e pausa) e 14 (interface) de `docs/conceito-de-jogo.md`. Duas regras duras: cor sozinha nunca distingue o lugar de pouso, o perigo e o cenário; e nenhuma ação essencial depende de passar o mouse por cima.

A demarcação do lugar de pouso **não** é UI: ela é arte dentro da cena, desenhada para aquele lugar (seção 10). Marcador genérico colado por cima da tela é exatamente o que o conceito recusa.
